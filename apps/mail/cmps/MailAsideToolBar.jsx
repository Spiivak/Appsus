...
export function MailAsideToolBar({ onToggleAddMail, onChangeToInboxMails, onChangeToSentMails }) {
    return (
        <aside className="mail-aside-tool-bar">
            <div className="grid justify-center align-center">
                ...
                <button className="btn btn-sent" onClick={onChangeToSentMails}><i className="ri-send-plane-2-line"></i></button>
